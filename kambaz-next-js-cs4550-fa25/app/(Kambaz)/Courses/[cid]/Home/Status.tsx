...
import { BsBarChartFill, BsFileBarGraph, BsFillBellFill, BsFillFileBarGraphFill, BsMegaphone } from "react-icons/bs";
{/* Find more icons */ }
  ...
  return (
    <div id="wd-course-status" style={{ width: "350px" }}>
      ...
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       ...
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <BsFillBellFill className="me-2 fs-5" /> View Course Notifications </Button>
